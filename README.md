...
Working so far:
* Most HUD features - Health, Flashlight, Hit Indicators, Damage type notifications, Ammo count (buggy)
* Flashlight - Toggle with 'J' key for now, will make configurable later
